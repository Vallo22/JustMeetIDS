...
public class EventController {
	...
	public String newEvent(@ModelAttribute("eventForm") Event eventForm, Principal user, BindingResult bindingResult) {
	...
	public String editEvent(Model model, @RequestParam long id) {
		model.addAttribute("eventDetails", eventService.findById(id));
